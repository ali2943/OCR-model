...
# -*- coding: utf-8 -*-
"""
Custom TrOCR Inference Script for Fine-tuned Model
...
class CustomTrOCR:
    ...
    def __init__(
        self,
        model_dir: str = './trocr_model/final',
        use_gpu: bool = True
    ):
        """
...
def main():
    ...
    parser = argparse.ArgumentParser(description='TrOCR Custom Inference')
    ...
    if not args.image and not args.batch:
        ...
        print("  python inference/predict_trocr.py path/to/image.jpg")
        print("\nWith detailed output:")
        print("  python inference/predict_trocr.py path/to/image.jpg --detail")
        print("\nBatch inference:")
        print("  python inference/predict_trocr.py --batch img1.jpg img2.jpg img3.jpg")
        print("\nCPU inference:")
        print("  python inference/predict_trocr.py path/to/image.jpg --cpu")
        print("\nCustom model directory:")
        print("  python inference/predict_trocr.py path/to/image.jpg \\")
        print("    --model_dir ./trocr_model/final")
        print("="*60)
        return
